...
public partial class Comprobante {
    ...
    public string UrlQr {
        get { 
            return "https://verificacfdi.facturaelectronica.sat.gob.mx/default.aspx?id="+TimbreFiscalDigital.UUID+
                "&re="+Emisor.Rfc+"&rr="+Receptor.Rfc+"&tt="+Total+"&fe="+Sello.Substring(Sello.Length-8,8);
        }
    }
...
public partial class NominaPercepciones {
    ...
    public List<Percepcion> PercepcionList { get; set; }
}
...
public partial class NominaDeducciones { 
    ...
    public List<Deduccion> DeduccionList { get; set; }
}
